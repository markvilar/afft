...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/qdch0ftq_20100428_020202_usbl_tracklink.csv" \
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/qdch0ftq_20110415_020103_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
  --deployment "qdch0ftq_20110415_020103"

# Verdict: ignore extrinsics
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/qdch0ftq_20120430_002423_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/qdch0ftq_20130406_023610_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/qdchdmy1_20110416_005411_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/qdchdmy1_20120501_071203_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/qdchdmy1_20130406_081713_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
  --deployment "qdchdmy1_20130406_081713"

# Verdict: use extrinsics (Evologics S2C 18/34)
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/r23685bc_20100605_021022_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/r23685bc_20120530_233021_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/r23685bc_20140616_225022_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/r29mrd5h_20090612_225306_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/r29mrd5h_20110612_033752_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/r29mrd5h_20130611_002419_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/r7jjskxq_20101023_210332_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/r7jjskxq_20121013_060425_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
...
uv run afft sensors process-tracklink-usbl-from-messages \
  ...
  --output-file "${OUTPUT_DIR}/r7jjskxq_20131022_004934_usbl_tracklink.csv" \
  --deployment-configs "${CONFIG_DIR}/deployment_configs_selected.toml" \
