...
PRIOR_CAMERA_POSE_DATA_DIR="${HOME}/data/acfr_stereo_camera_poses_v1_renav_squidle_merged"
REGISTERED_CAMERA_POSE_DATA_DIR="${HOME}/data/acfr_stereo_camera_poses_v1_benthloc_registered"
