...
CAMERA_POSE_DATA_DIR="/data/exos_01/acfr_camera_poses_v1_renav_corrected"
METASHAPE_CAMERA_POSE_DATA_DIR="/data/exos_01/acfr_deployment_stereo_camera_poses_v1"
