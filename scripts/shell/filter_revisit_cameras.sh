...
ROOT="/media/martin/barracuda"

INPUT_DIR="$ROOT/acfr_revisits_cameras/acfr_cameras_renav"
OUTPUT_DIR="$ROOT/acfr_revisits_cameras/acfr_cameras_renav_filtered"
LABEL_DIR="$ROOT/acfr_revisits_cameras/acfr_camera_labels"

echo "Uncomment exit command in script to execute batch processing"

echo "---------- FILTER CAMERA SCRIPT ----------"
...
poetry run afft-cli filter-cameras \
  "$INPUT_DIR/r29mrd5h_20090612_225306_cameras.csv" \
